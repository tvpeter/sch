                        ...
                        <div class="row">
                         ...
                         <div class="col-md-6">
                            ...
                            <div class="card-body"> <p class="p-2 mb-2 bg-dark text-white text-center">STUDENT INFORMATION</p><hr>
                                    ...
                                    <div class="row">
                                     <span class="text-center col-md-12"><strong>SESSIONS' PERFORMANCE</strong></span>
                                    </div><hr>
                                    
                                    <div class="row">
                                     <span class="text-right col-md-3">ANNUAL AVERAGE</span>
                                    <span class="col-md-9 text-primary"><?= round($avg, 2); ?></span></div><hr>
                                    
                                    <div class="row">
                                     <span class="text-right col-md-3">POSITION:</span>
                    ...
                    <div class="col-md-6">
                          <div class="card">
                                    <div class="card-body"><p class="p-2 mb-2 bg-dark text-white text-center">STUDENT PROMOTION</p><hr>
                                                <?php  if (isset($suc['msg'])) {  echo "<span class='text-success'>".$suc['msg']."</span>";  } ?>
                                ...
                                <?php endforeach; ?> </select>
                                    ...
                                    THIS PROMOTION IS FOR <?= $nsession ." SESSION"; ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <a href="annualresult.php" title="Back" class="btn btn-primary"><i class="fa fa-reply"></i>&nbsp;BACK</a>
                                                 </div>
                                                 <div class="col-md-6">
