...
?>
                    ...
                    <div class="col-md-6">
                           <div class="card">
                            ...
                            <div class="tab-content">
                             ...
                             <div><span><a href="viewsubjects.php?cid=<?=  $admno; ?>& class=<?= $class; ?>& session=<?= $session; ?> &term=Term I" class="btn btn-primary"><i class="fa fa-tag"></i>&nbsp;Term I</a> </span>
        ...
        <?php  if (isset($error['image'])) {  echo "<span class='text-danger'>".$error['image']."</span>";  } ?>
                             ...
                             <p class="text-primary">Position: <?php if ($firstTerm['position']) {
                                 echo $firstTerm['position'];
                             } else { echo"Not yet computed"; } ?></p>
                             ...
                             <p class="text-primary">Position: <?php if ($annualRs['pos']) {
                                 echo $annualRs['pos'];} else { echo "Not yet computed"; } ?></p>                            
                                                                </div>
                                </div>
