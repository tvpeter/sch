...
<div class="container-fluid">
            ...
            <select class="custom-select" name="class" required aria-required="true">
                  ...
                  <option value="<?= $sub['subject']; ?>"><?= $sub['subject']; ?></option>
                    ...
                    <?php  if (isset($error['regsubject'])) {  echo "<span class='text-danger'>".$error['regsubject']."</span>";  } ?>
                                                </div>
                                            </div>
                                        </div>
                  ...
                  <option value="<?= $class['class']; ?>"><?= $class['class']; ?></option>
                                            ...
                                            <select class="custom-select" name="checkterm" required aria-required="true">
                                                 ...
                                                 <div class="col-md-3">
                                            <button type="submit" class="btn btn-dark btn-outline" name="checksubjects"> <i class="fa fa-check"></i> Check</button>
                                                 </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="p-3 mb-2 bg-secondary text-white">
                                REGISTERED SUBJECTS &amp; NO OF STUDENTS FOR <?= $cclass." ".strtoupper($cterm)." ".$csession; ?>
                            </div>
                            <div class="card-body">
