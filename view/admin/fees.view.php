...
<div class="container-fluid">
        <style type="text/css"> input {  text-align: right; }</style>
            ...
            <div class="col-lg-6">
                    ...
                    <div class="row mt-1">
                    <div class="col-md-12 text-center"><?php  if (isset($error['failure'])) {  echo "<span class='alert alert-danger'>".$error['failure']."</span>";  }
                        if (isset($_GET['msg'])) {  echo "<span>".$_GET['msg']."</span>";  }
                     ?></div></div>

                    <div class="row mt-3">
                    <div class="col-md-3">
                     <label class="control-label">SESSION: </label></div>
                     <div class="col-md-9">
                  ...
                  <?php  if (isset($error['session'])) {  echo "<span class='text-danger'>".$error['session']."</span>";  } ?></div> 
                    ...
                    <div class="row mt-3">
                    <div class="col-md-3">
                        <label class="control-label">TERM: </label></div>
                    <div  class="col-md-9">
                 ...
                 <div class="col-md-9">
                   ...
                   <?php if (isset($error['section'])) {  echo "<span class='text-danger'>".$error['section']."</span>";  } ?></div> </div>

                    <div class="row mt-3">
                     <div class="col-md-3"><label class="control-label">Payment in the Bank </label></div>
        <div class="col-md-9">
    <input type="number"  required="required" name="pib" class="form-control" value="0"> 
                   </div>
               </div>
               <div class="row mt-3 mb-3">
                     <div class="col-md-3"><label class="control-label">Payment in the Sch. </label></div>
        <div class="col-md-9">
    <input type="number"  required="required" name="pis" class="form-control" value="0"> 
                   </div>
               </div>
                    <!--                 
    ...
    <button type="submit" class="btn btn-dark" name="submit"> <i class="fa fa-check"></i> Submit</button></div></div>
                ...
                <div class="col-md-3">
                  ...
                  <?php  if (isset($error['section'])) {  echo "<span class='text-danger'>".$error['section']."</span>";  } ?></div>
                    ...
                    <div class="col-md-3">
                <button type="submit" class="btn btn-dark btn-outline" name="check"> 
                <i class="fa fa-check"></i> Check</button>
                            ...
                            <tbody>
                        <tr><td>Payment in the Bank</td><td class='text-primary'><?php if($pib){ echo $pib;} ?></td></tr>
                                <tr><td>Payment in School</td><td class='text-primary'><?php if($pis){ echo $pis; } ?></td></tr>                                                              
     <?php   
//  $total = $tuition+$dev+$medical+$exams+$idcard+$locker+$cbooklet+$edulevy +$pta+$lesson+$utility+$cathe+$sports+$party+$dvd;  
