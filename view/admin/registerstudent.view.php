            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-6">
                        <div class="card card-outline-info">
                            ...
                            <h4 class="m-b-0 text-white">NEW STUDENT REGISTRATION</h4>
                                ...
                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                                        ...
                                        <div class="form-group has-success">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                   ...
                                                   <?php  if (isset($error['admno'])) {  echo "<span class='text-danger'>".$error['admno']."</span>";  } ?>
                                                                                                   </div>
                                            </div>
                                        </div>
                                           <div class="form-group has-success">
                                        ...
                                        <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                        ...
                                                        <button type="" class="btn btn-inverse">Cancel</button>
                                                    </div>
                                            </div>
