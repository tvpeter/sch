                                ...
                                <div class="p-3 mb-2 bg-dark text-white" align="center"><strong><?= "RESULTS FOR ".$_POST['class']." STUDENTS ".$_POST['session']." ".strtoupper($_POST['term']); ?></strong></div>
                                  ...
                                  <div class="table-responsive m-t-40">
                                    ...
                                    <table id="myTable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                    <tr><th>SN</th><th>STUDENT NAME</th><th>ADMNO</th><th>SUBJECTS <br> TAKEN</th> <th>TOTAL <br>MARKS</th><th>AVERAGE</th><th>POS</th><th>REVIEW</th><th>PRINT</th>
                                            </tr></thead>
                                            
                                        <tbody>  
                                             <?php $n = 0;

                             foreach ($resultsDetails as $rs){  $n++;  
                                extract($rs);                         
                                ...
                                ?>  
                                        ...
                                        <td><a href="resultsreview.php?cid=<?= $admno; ?>&class=<?= $_POST['class']; ?>&session=<?= $_POST['session']; ?>&term=<?= $_POST['term']; ?>" title="Review"><i class="fa fa-edit fa-2x"></i></a></td>
                                         <td><a href="results.php?cid=<?= $admno; ?>&class=<?= $_POST['class']; ?>&session=<?=  $_POST['session']; ?>&term=<?= $_POST['term']; ?>" title="Details"><i class="fa fa-check-circle fa-2x"></i></a></td>                                             </tr>
                                           <?php 
                                           if ($subno !== 0) {
                                               $avgs = $gtotal/$subno;
                                           }else{
