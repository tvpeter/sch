            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-home"></i><span class="hide-menu">Class</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="classtudents.php">Students In a Class</a></li>
                                <li><a href="createclass.php">Create Class</a></li>
                                <li><a href="subno.php">Set A Class Subjects No</a></li>
                                <li><a href="subjectclass.php">Register Class a Subject</a></li>
                              
                              </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">Subjects</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="subjects.php">Create Subject</a></li>
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-address-card"></i><span class="hide-menu">Results</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="subject.php">Termly Subject Scores</a></li>
                                 <li><a href="viewresults.php">Termly Class Results</a></li>
                                 <li><a href="asubrecords.php">Annual Subject Scores</a></li>
                                 <li><a href="annualresult.php">Annual Results</a></li>
                              </ul>
                        </li>
