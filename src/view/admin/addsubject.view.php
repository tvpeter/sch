                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <form action="" method="post">
                                    ...
                                    ?>
                                    <tr>
                                        <td colspan="2"> <a href="viewsubjects.php?cid=<?= htmlentities($gadmno); ?>&session=<?= $gsession; ?>&class=<?= $gclass; ?>&term=<?= $gterm; ?>" title="Back" class="btn btn-primary"><i class="fa fa-reply"></i>&nbsp;BACK</a></td>
                                        <td> <button class="btn btn-primary" name="adds" type="submit"><i class="fa fa-plus"></i>&nbsp;ADD SUBJECT</button></td>
                                    </tr>
                                </form>
                            </tbody>
                        </table>
