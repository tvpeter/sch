      ...
      <div class="card">
        <div align="right">
          <?php if (!empty($passport)) {
            echo "<img src='passports/$passport' class='img'>";
          } ?>
        </div>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover">
                  ...
                  ?>
                    <tr style="font-weight: bold;">
                      ...
                      <td>
                        ...
                        ?>
                          <a href="editscore.php?cid=<?= htmlentities($gadmno); ?>&class=<?= htmlentities($gclass); ?>&session=<?= $gsession; ?>&term=<?= htmlentities($gterm); ?>&subj=<?= htmlentities($subj); ?>" title="Edit Score">
              ...
              <tfoot>
                <tr>
                  <td colspan="4">
                    <a href="student.php?cid=<?= htmlentities($gadmno); ?>&session=<?= $gsession; ?>" title="Back" class="btn btn-primary"><i class="fa fa-reply"></i>&nbsp;BACK</a>
                  </td>
                  <?php
                  if ($query->lookUp("id", "termstatus", ["class" => $gclass, "session" => $gsession, "term" => $gterm, "results_status" => "approved"]) != 1) {
                  ?>
